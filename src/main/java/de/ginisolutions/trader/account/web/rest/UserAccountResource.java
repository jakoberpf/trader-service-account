...
/**
 * REST controller for managing {@link de.ginisolutions.trader.account.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
public class UserAccountResource {
    ...
    private static final String ENTITY_NAME = "traderServiceAccountUserAccount";
